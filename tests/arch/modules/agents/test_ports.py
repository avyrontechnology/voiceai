...
SESSION_STORE_PORT_METHODS = frozenset({"get_prompts", "save_prompts"})
...
def test_the_ports_split_the_six_contract_methods():
    """Renaming or moving a port method must be loud: spec 0002 names exactly these six."""
