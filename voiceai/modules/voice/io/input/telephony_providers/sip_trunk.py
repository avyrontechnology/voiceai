...
from voiceai.modules.voice.adapters.io_runtime import create_ws_data_packet
...
class SipTrunkInputHandler(TelephonyInputHandler):
    ...
    def _get_input_config(self) -> Any:
        try:
    ...
    def _initialize_from_media_start(self, media_start_data: Any) -> None:
    ...
    def _restart_dtmf_timer(self) -> None:
    ...
    async def _dtmf_timeout(self) -> None:
        try:
