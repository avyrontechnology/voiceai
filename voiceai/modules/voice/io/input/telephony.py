...
class TelephonyInputHandler(DefaultInputHandler):
    ...
    async def _safe_disconnect_stream(self) -> None:
    ...
    async def ingest_audio(self, audio_data: Any, meta_info: Any) -> None:
        """Ingest one audio frame into the pipeline."""
