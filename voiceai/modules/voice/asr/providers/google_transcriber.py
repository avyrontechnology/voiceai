...
class GoogleTranscriber(BaseTranscriber):
    ...
    async def google_connect(self) -> Any:
        ...
        try:
            ...
            raise ConnectionError(f"Failed to validate Google Speech client: {e}")  # noqa: B904 — verbatim raise without cause (R8)
    ...
    async def _transcribe_wrapper(self) -> None:
    ...
    async def _send_audio_to_transcriber(self) -> None:
    ...
    def _run_grpc_stream(self) -> None:
        """
