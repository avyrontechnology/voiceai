...
from voiceai.modules.voice.adapters.tts_runtime import InmemoryScalarCache, get_ssl_context, pcm_to_ulaw, resample
from voiceai.modules.voice.constants import MODULE_NAME
from voiceai.modules.voice.tts.providers import kalpa_http as _kalpa_http
...
class KalpaSynthesizer(StreamSynthesizer):
    ...
    def _process_audio_chunk(self, chunk: Any) -> Any:
    ...
    async def _resolve_voice_id(self) -> Any:
    ...
    async def _send_frame(self, payload: Any) -> None:
    ...
    @staticmethod
    def _truncate_at_word(text: Any, limit: Any) -> Any:
    ...
    async def _close_ws(self, reason: Any) -> None:
    ...
    def _retired(self, sequence_id: Any, interrupt_gen: Any) -> Any:
    ...
    async def _wait_for_idle_slot(self, sequence_id: Any, interrupt_gen: Any) -> Any:
    ...
    async def _open_utterance(self, sequence_id: Any, interrupt_gen: Any) -> Any:
        ...
        while True:
            ...
            if self._turn_dead and not self._response_idle.is_set():
                ...
                except Exception:  # noqa: S112 — verbatim best-effort continue (R8)
    ...
    def _wire_text(self, text: Any, replay: Any) -> Any:
    ...
    async def _finish_utterance(self, sequence_id: Any, interrupt_gen: Any) -> None:
    ...
    def _sentinel_owns_queue_head(self) -> Any:
    ...
    def _settle_slot(self, emit: Any) -> Any:
    ...
    def _settle_lost_utterance(self) -> Any:
    ...
    def _decode_audio(self, pcm_b64: Any) -> Any:
        if not pcm_b64:
            return None
        try:
    ...
    def _initialize_message(self) -> Any:
        message = {
    ...
    async def _generate_http(self, text: Any) -> Any:
        return await _kalpa_http.generate_http(self, text)

    async def synthesize(self, text: Any) -> Any:
        """One-shot render; delegates to kalpa_http (same seam, same values)."""
        return await _kalpa_http.synthesize(self, text)

    async def synthesize_telephony_clip(self, text: Any) -> Any:
        """Mu-law one-shot; delegates to kalpa_http (same seam, same values)."""
        return await _kalpa_http.synthesize_telephony_clip(self, text)

    def _process_http_audio(self, audio: Any) -> Any:
        return _kalpa_http.process_http_audio(self, audio)

    def _get_http_audio_format(self) -> Any:
        return _kalpa_http.get_http_audio_format(self)
