...
class SynthesizerPool:
    ...
    def __init__(self, synthesizers: Any, active_label: Any, multilingual_config: Any) -> None:
        """
        Args:
    ...
    async def _run_generate(self, label: Any) -> None:
    ...
    def get_active_synthesizer_info(self) -> Any:
