...
- [x] Slice 3: synthesizer model/engine + voice + language validation;
  sample-URL mechanism + shape guard (curation needs provider assets —
  tracked gap, not scraped); UI sync in spec 0023.
